    ...
    <div className="flex flex-col justify-center items-center bg-[#090909]">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-16 pb-16">
        ...
        <div className="flex flex-col gap-12">
          <img src={images.barfront} alt="bar front" />
          <h1 className=" text-center lg:text-left font-serif text-orange-400 text-[30px] lg:text-[45px] font-semibold capitalize lg:leading-[62px] tracking-[0.04em]">
            Over the Years
          </h1>
